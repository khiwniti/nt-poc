 ...
 */
router.get('/rul-comparison', async (req: AuthRequest, res: Response) => {
  try {
 ...
 */
router.get('/anomaly-comparison', async (req: AuthRequest, res: Response) => {
  try {
    const { facilityId, startDate, endDate, batteryType } = req.query;
 ...
 */
router.get('/error-distribution', async (req: AuthRequest, res: Response) => {
  try {
    const { facilityId, startDate, endDate, batteryType } = req.query;
 ...
 */
router.get('/root-cause', async (req: AuthRequest, res: Response) => {
  try {
    ...
    const params: any[] = [errorThreshold];
    let paramIndex = 2;
