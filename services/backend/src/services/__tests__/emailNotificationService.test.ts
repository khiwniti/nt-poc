...
describe('EmailNotificationService', () => {
  ...
  beforeEach(() => {
    ...
    (EmailNotificationService as any).instance = undefined;
  ...
  describe('Email content generation', () => {
    it('should include all alert details in email', async () => {
      ...
      const htmlContent = capturedBody.content.find((c: any) => c.type === 'text/html').value;
      ...
      const textContent = capturedBody.content.find((c: any) => c.type === 'text/plain').value;
