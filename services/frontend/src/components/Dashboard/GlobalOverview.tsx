    ...
    <div className="w-full h-full flex flex-col">
        <div className="flex items-center justify-between mb-6 border-b border-slate-100 pb-4">
            <div>
                ...
                <p className="text-xs text-slate-500 uppercase tracking-widest font-bold mt-1">ข้อมูลโครงสร้างพื้นฐานระดับประเทศ (National Infrastructure)</p>
            </div>
        ...
        <div className="grid grid-cols-1 gap-5 flex-1 overflow-y-auto pr-2 pb-4">
            ...
            >
                ...
                <div className="flex items-start justify-between relative z-10">
                    <div>
                        <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block mb-2 group-hover:text-nt-yellow transition-colors">ความต้องการพลังงานรวม</span>
            ...
            {/* Scale Grid - Updated counts based on research */}
            <div className="grid grid-cols-2 gap-5">
                ...
                >
                    ...
                    <div>
                        ...
                        <span className="text-xs block font-bold text-slate-500 uppercase group-hover:text-indigo-600 transition-colors mt-1">ศูนย์ข้อมูล</span>
                    </div>
                </div>
                <div 
                    onClick={() => onChangeView('utility')}
                ...
                >
                    ...
                    <div>
                        <span className="text-3xl font-black text-slate-800">12.5k</span>
                        <span className="text-xs block font-bold text-slate-500 uppercase group-hover:text-emerald-600 transition-colors mt-1">สตริงแบตเตอรี่</span>
                    </div>
                </div>
            </div>
            ...
            >
                <div className="flex items-center gap-4 mb-5">
                    ...
                    <div>
                        <h4 className="text-sm font-bold text-slate-800 group-hover:text-orange-600 transition-colors">ดัชนีประสิทธิภาพ (PUE)</h4>
            ...
            >
                <div className="flex justify-between items-start mb-4">
                    ...
                    <button 
                        onClick={(e) => { e.stopPropagation(); handleSystemCheck(); }}
