...
function AlertStatsDashboard({ filters = {} }: AlertStatsDashboardProps) {
  ...
  // Status data for potential future use
  // const statusData = [
  //   { name: 'Active', value: stats.byStatus.active, color: '#ef4444' },
  //   { name: 'Acknowledged', value: stats.byStatus.acknowledged, color: '#f59e0b' },
  //   { name: 'Resolved', value: stats.byStatus.resolved, color: '#10b981' },
  // ];
