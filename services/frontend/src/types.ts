// Re-export all types from the types directory (new facility management system)
...
export interface ReportBlock {
    id: string;
    type: 'h1' | 'h2' | 'h3' | 'paragraph' | 'bullet' | 'todo' | 'code' | 'ai-insight' | 'data-widget';
    content: string;
    checked?: boolean;
    widgetData?: any; // For charts or structured data
}
