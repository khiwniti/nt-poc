...
test.describe('Accessibility Tests', () => {
  ...
  test('Dashboard page should not have any automatically detectable accessibility violations', async ({ page }) => {
    await page.goto('/');
  ...
  test('Assets page should not have accessibility violations', async ({ page }) => {
  ...
  test('Comparative Analysis page should not have accessibility violations', async ({ page }) => {
    await page.goto('/comparative-analysis');
    await page.waitForLoadState('networkidle');
